...
public:
    void visit(Square& square) override {
        cout << "Drawing a square with side length " << square.getM_side() << endl;
    }

    void visit(Circle& circle) override {
        cout << "Drawing a circle with radius " << circle.getM_radius() << endl;
    }

    void visit(Rectangle& rectangle) override {
        cout << "Drawing a rectangle with width " << rectangle.getM_width()
            << " and height " << rectangle.getM_height() << endl;
    }
};
int main() {
